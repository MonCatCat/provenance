...
# " [#number](https://github.com/MonCatCat/provenance/issues/<number>)
...
for line in fileinput.input(inplace=1):
    line = re.sub(r"\sPR([0-9]+)", r" [PR \1](https://github.com/MonCatCat/provenance/pull/\1)", line.rstrip())
    line = re.sub(r"\s#([0-9]+)", r" [#\1](https://github.com/MonCatCat/provenance/issues/\1)", line)
    print(line)
