...
func TestRandomizedGenState(t *testing.T) {
	...
	var msgFeesGenesis types.GenesisState
	simState.Cdc.MustUnmarshalJSON(simState.GenState[types.ModuleName], &msgFeesGenesis)

	require.Equal(t, "blah", msgFeesGenesis.Params.FloorGasPrice.Denom)
