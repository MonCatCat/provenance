...
func TestGenesisState_Validate(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:     "one holds: good",
			genState: GenesisState{Holds: []*AccountHold{ahGood1}},
		},
		{
			name:     "one hold: bad",
			genState: GenesisState{Holds: []*AccountHold{ahBad}},
			expErr:   []string{badErr(0)},
		},
		{
			name:     "one hold: nil",
			genState: GenesisState{Holds: []*AccountHold{nil}},
			expErr:   []string{nilErr(0)},
		},
		{
			name:     "two holds: good good",
			genState: GenesisState{Holds: []*AccountHold{ahGood2, ahGood3}},
		},
		{
			name:     "two holds: good bad",
			genState: GenesisState{Holds: []*AccountHold{ahGood1, ahBad}},
			expErr:   []string{badErr(1)},
		},
		{
			name:     "two holds: bad good",
			genState: GenesisState{Holds: []*AccountHold{ahBad, ahGood1}},
			expErr:   []string{badErr(0)},
		},
		{
			name:     "two holds: good nil",
			genState: GenesisState{Holds: []*AccountHold{ahGood1, nil}},
			expErr:   []string{nilErr(1)},
		},
		{
			name:     "two holds: nil good",
			genState: GenesisState{Holds: []*AccountHold{nil, ahGood1}},
			expErr:   []string{nilErr(0)},
		},
		{
			name:     "two holds: bad nil",
			genState: GenesisState{Holds: []*AccountHold{ahBad, nil}},
			expErr:   []string{badErr(0), nilErr(1)},
		},
		{
			name:     "two holds: nil bad",
			genState: GenesisState{Holds: []*AccountHold{nil, ahBad}},
			expErr:   []string{nilErr(0), badErr(1)},
		},
		{
			name:     "two holds: same",
			genState: GenesisState{Holds: []*AccountHold{ahGood1, ahGood1}},
			expErr:   []string{dupErr(1, 0)},
		},
		{
			name:     "three holds: good good good",
			genState: GenesisState{Holds: []*AccountHold{ahGood1, ahGood2, ahGood3}},
		},
		{
			name:     "three holds: good bad good",
			genState: GenesisState{Holds: []*AccountHold{ahGood1, ahBad, ahGood3}},
			expErr:   []string{badErr(1)},
		},
		{
			name:     "three holds: good nil bad",
			genState: GenesisState{Holds: []*AccountHold{ahGood1, nil, ahBad}},
			expErr:   []string{nilErr(1), badErr(2)},
		},
		{
			name:     "three holds: same first and third bad second",
			genState: GenesisState{Holds: []*AccountHold{ahGood1, ahBad, ahGood1}},
			expErr:   []string{badErr(1), dupErr(2, 0)},
		},
		{
			name:     "three holds: all same",
			genState: GenesisState{Holds: []*AccountHold{ahGood1, ahGood1, ahGood1}},
			expErr:   []string{dupErr(1, 0), dupErr(2, 0)},
		},
		{
			name:     "six holds: good1 bad good2 nil good1 good3",
			genState: GenesisState{Holds: []*AccountHold{ahGood1, ahBad, ahGood2, nil, ahGood2, ahGood3}},
